...
function Home() {
  ...
  const [state, setState] = useState({
    series: [{
      name: 'Income ($)',
      type: 'column',
      data: [6000, 9000, 15000, 20000]
    }, {
      name: 'Average Salary ($)',
      type: 'line',
      data: [38358.5, 38358.5, 38358.5, 38358.5]
    }],
    options: {
      chart: {
        height: 350,
      ...
      xaxis: {
        categories: ['Naomi', 'Steve', 'Walter', 'kmkom'],
      },
      yaxis: [
        {
          axisTicks: {
  ...
  const [chart2Data, setChart2Data] = useState({
    series: [{
      name: 'Workers in Day Shift',
      type: 'line',
      data: [1,4,2,5,3,1,4]
    },{
      name: 'Workers in Night Shift',
      type: 'line',
      data: [2,5,3,4,1,3,2]
    }
    ...
    options: {
      ...
      title: {
        text: 'Number of Workers in Shift - Current Week',
        align: 'left',
        fontSize: 25,
        offsetX: 110
      },
